...
const customers = [
  { id: "c-1", name: "Lee Atkinson", phone: "6411111111", email: "lee@atkinson.com", stage: "prospect", source: "walk-in" },
  { id: "c-2", name: "John Smith", phone: "0412345678", email: "john@example.com", stage: "service", source: "-" },
  ...Array.from({ length: 12 }, (_, i) => ({
    id: `c-${i+3}`, name: "John Smith", phone: "0412345678", email: "john@example.com", stage: "active", source: "-"
  }))
];
            ...
            <tbody className="divide-y divide-neutral-100">
              {customers.map((c) => (
                <tr key={c.id} className="hover:bg-neutral-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <Badge tone={c.stage === "prospect" ? "blue" : c.stage === "service" ? "orange" : "green"}>{c.stage}</Badge>
                  </td>
